...
export default function RsvpSelect(
    ...
    return (
        <Select key={items.join("-")} onChange={(e) => setFunction(e.target.value)} className="bg-gray-100 md:bg-black text-black md:text-white text-base md:text-lg p-1 m-1 pl-3 uppercase tracking-widest">
            {items.map((item) => (
