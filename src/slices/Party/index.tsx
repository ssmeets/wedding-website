            ...
            {slice.primary.events.map((item, index) => (
              ...
              <div className={clsx("grid grid-cols-1 md:grid-cols-4 gap-4", (index % 2 == 0) ? "opacity-1" : "opacity-0 hidden")} ref={refs[index]} key={index}>
                ...
                <div className="md:row-start-1">
                  ...
                  <Button onClick={() => window.open("https://www.google.com/maps/place/" + item.map.latitude + "," + item.map.longitude, "_blank")} className="font-content bg-white border-[1px] border-black md:border-0 md:bg-black py-2 px-4 text-sm text-black md:text-white uppercase data-[hover]:bg-gray-600 data-[active]:bg-gray-700">
